...
def test_demo_console_page_loads():
    ...
    assert "criticCopySelectedFindingIdsBtn" in body
    assert "criticLoadFindingIdsFromWorkflowBtn" in body
...
def test_demo_console_exposes_end_to_end_bulk_review_controls():
    ...
    required_tokens = [
        ...
        "reviewWorkflowSuggestedActionsList",
        "reviewWorkflowPostApplySummaryList",
        "applySuggestedFindingActionBtn",
        "applySuggestedCommentActionBtn",
        ...
        "renderSendGate",
        "renderSuggestedOpsActions",
        "renderPostApplySummary",
        "refreshWorkflowAfterBulkApply",
        "findingActionPresetFromQueue",
        "commentActionPresetFromQueue",
